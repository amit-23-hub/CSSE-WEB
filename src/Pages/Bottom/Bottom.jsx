    ...
    <div className='h-80 w-full bg-slate-900 flex flex-col justify-center items-center border-t-4 border-gray-600 pt-3'>
      <div className='flex justify-between w-11/12 items-center'>
        <div className='flex-col justify-center w-28'>
          <Link to={'http://www.mmmut.ac.in/'}><img className='rounded-full relative left-[2rem]' src={Logo} alt="" /></Link>
        ...
        '>Madan Mohan Malaviya University Of Technology, Gorakhpur</h1>
          ...
          <ul>
            <Link to={'https://csse-web-eight.vercel.app/'}><li className='cursor-pointer text-zinc-400 flex hover:bg-slate-800 hover:text-zinc-200 font-medium p-1 hover:scale-110 transition-transform duration-300 hover:scale-110 transition-transform duration-300'>Home</li></Link>
          ...
          <ul>
            ...
            <Link to={'http://www.mmmut.ac.in/'}><li className='cursor-pointer text-zinc-400 flex hover:bg-slate-800 hover:text-zinc-200 font-medium p-1 hover:scale-110 transition-transform duration-300'>About College</li></Link>
          </ul>
          <div>
        ...
        <div className='w-28 mr-12'>
          <img className='rounded-full' src={csselogo} alt="csse" />
            ...
            '>Computer Society of Software Engineers</h1>
        </div>
      </div>
      <BottomNav/>
      <p className='text-zinc-400 mt-4 border-t w-full text-center'>This is the official website of Computer society of Software Engineers,  Departmental society of Information Technology at Madan Mohan Malaviya University of Technology</p>
      <p className='text-white font-medium text-sm pb-2'>© Copyright 2024. All Rights Reserved
       Powered by Team</p>
    </div>
  )
}
