...
const Section = () => {
  return (
    <div className={styles.container}>
      ...
      <section className={`${styles.color} ${styles.ssStyleCurvedown} overflow-hidden flex flex-col-reverse md:flex-row items-center justify-between p-8`}>
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end mb-6 md:mb-0">
          <div className={`${styles.hexagon} overflow-hidden hover:scale-110 transition-transform duration-300 ease-in-out mr-0 md:mr-20`}>
            <img
              src={img1}
              alt="Hexagonal Image"
      ...
      <section className={`${styles.color} overflow-hidden flex flex-col md:flex-row items-center justify-between`}>
