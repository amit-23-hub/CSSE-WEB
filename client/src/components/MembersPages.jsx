      ...
      <>
         ...
         <div className="flex flex-col min-h-screen items-center bg-slate-950">
            ...
            <div className="flex gap-4 mb-4">
               <button
                  className={`${filter === "All" ? "bg-red-600 text-white" : "bg-gray-600 text-zinc-300"
               ...
               <button
                  className={`${filter === "MCA" ? "bg-red-600 text-white" : "bg-gray-600 text-zinc-300"
                     } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
               ...
               <button
                  className={`${filter === "BTech" ? "bg-red-600 text-white" : "bg-gray-600 text-zinc-300"
                     } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
               ...
               <button
                  className={`${filter === "Student Lead" ? "bg-red-600 text-white" : "bg-gray-600 text-zinc-300"
                     } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
               ...
               <button
                  className={`${filter === "Alumni" ? "bg-red-600 text-white" : "bg-gray-600 text-zinc-300"
                     } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
            ...
            {filter === "BTech" && (
               <div className="flex gap-4 mb-4">
                  <button
                     className={`${btechYear === "All" ? "bg-blue-600 text-white" : "bg-gray-600 text-zinc-300"
                        } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
                  ...
                  <button
                     className={`${btechYear === "2nd Year" ? "bg-blue-600 text-white" : "bg-gray-600 text-zinc-300"
                        } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
                  ...
                  <button
                     className={`${btechYear === "3rd Year" ? "bg-blue-600 text-white" : "bg-gray-600 text-zinc-300"
                        } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
                  ...
                  <button
                     className={`${btechYear === "4th Year" ? "bg-blue-600 text-white" : "bg-gray-600 text-zinc-300"
                        } py-2 px-4 rounded-full font-semibold transition-colors duration-200`}
