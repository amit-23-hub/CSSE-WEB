  ...
  return (
    <div className={styles.container}>
      ...
      <section className="col2 color ss-style-curvedown overflow-hidden flex flex-col md:flex-row items-center justify-between p-8 bg-black">
        ...
        <div id="about" className="w-full md:w-1/2 text-white mr-10">
      ...
      <section id="vision" className="col2 color ss-style-curvedown overflow-hidden flex flex-col md:flex-row-reverse items-center justify-between p-8 bg-black">
        <div className="w-full md:w-1/2 flex justify-center md:justify-end mb-6 md:mb-0">
          <div className="logo-div relative overflow-hidden hover:scale-110 transition-transform duration-300 ease-in-out mr-0 md:mr-60">
            <img
              src={edTech}
      ...
      <section id="gallery" className={`${styles.col3} ${styles.ssStyleDoubleDiagonal} pt-3 pb-5`}>
        <Gallery />
      </section>
